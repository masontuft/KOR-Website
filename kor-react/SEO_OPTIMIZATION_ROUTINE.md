...
| TASK-002 | performance     | `bike-maintenance-schedule.webp` was 272 KB, the largest hero image. Fixed: re-encoded with `cwebp` (q=30, method=6, sharp_yuv) at the original 1600x893 resolution — 272 KB → 137 KB, visually verified against the original at full display size with no visible quality loss. `npm run build` passes. PR #89 open. | in_review | 2026-07-24 |
